...
git clone https://github.com/snorose/2026-hackathon-hands-on.git "Solar Teacher Low-Code"
```
...
압축을 풀면 폴더 이름이 `2026-hackathon-hands-on-main`처럼 보일 수 있습니다. 이후 문서의 명령어를 그대로 따라 하려면 이 폴더 이름을 `Solar Teacher Low-Code`로 바꿔 두면 편합니다.
