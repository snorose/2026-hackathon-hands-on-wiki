...
```text
https://github.com/snorose/2026-hackathon-hands-on
```
...
```bash
git clone https://github.com/snorose/2026-hackathon-hands-on
```

이렇게 받으면 이후 문서의 경로와 같은 `2026-hackathon-hands-on` 폴더가 만들어집니다.

### ZIP 파일로 받기

GitHub 계정이 없거나 Git 사용이 익숙하지 않다면 ZIP 파일로 받을 수 있습니다.

1. 브라우저에서 `https://github.com/snorose/2026-hackathon-hands-on`에 접속합니다.
2. 초록색 `Code` 버튼을 누릅니다.
...
```text
https://github.com/snorose/2026-hackathon-hands-on/archive/refs/heads/main.zip
```

압축을 풀면 폴더 이름이 `2026-hackathon-hands-on-main`처럼 보일 수 있습니다. 이후 문서의 명령어를 그대로 따라 하려면 이 폴더 이름을 `2026-hackathon-hands-on`로 바꿔 두면 편합니다.
