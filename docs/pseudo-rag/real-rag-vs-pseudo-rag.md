---
title: 실제 RAG와 Pseudo-RAG의 차이
---

# 실제 RAG와 Pseudo-RAG의 차이

이번 실습의 Pseudo-RAG는 참고자료를 직접 붙여넣는 방식입니다.

`Pseudo-RAG`는 표준 용어라기보다, 실제 RAG의 형태를 간단히 흉내 내는 실습용 표현입니다. 실제 서비스 수준의 RAG처럼 문서를 저장하고 검색하는 단계는 아직 포함하지 않습니다.

실제 서비스에서는 보통 참고자료를 미리 저장해 두고, 질문과 관련 있는 부분만 찾아서 AI에게 전달합니다.

## 비교

| 구분 | Pseudo-RAG | 실제 RAG |
| --- | --- | --- |
